...
import { TM, FC } from '../../constants';

export default (
    <div className="wrapper">
        <h1>{FC}{TM} System</h1>

        <h2>{FC}{TM} System Facts</h2>
        <p>
            The {FC}{TM} System teaches a woman and couple to identify
        ...
        <h2>The {FC}{TM} System is more than Natural Birth Control</h2>
        <p>
            Couples report the {FC}{TM} System is so much more than natural birth
            control. Birth control has only one purpose, preventing pregnancy.
            The {FC}{TM} System is also very effective to achieve pregnancy. As an
        ...
        <p>
            {FC}{TM} System works in union with NaProtechnology helping women/couples with:
        </p>
        <ul>
        ...
        <h2>CREIGHTON MODEL <br /> {FC}{TM} <i>System and Infertility</i></h2>
        <p>
            {FC}{TM} System provides new hope for couples who are going
        ...
        <h2>{FC}{TM} System is easy to learn</h2>
        <p>
        ...
        <h2> Basic Facts</h2>
        <ul>
            <li>Regular cycles are not necessary to use the FC™ System</li>
        ...
        <h2>FC System is the First Step to NaPro<b>TECHNOLOGY</b>®.</h2>
        <p>
            Through NaPro<b>TECHNOLOGY®</b>, a new reproductive science that has its
            roots in the CREIGHTON MODEL {FC}{TM} System, Physicians, Nurse Practitioners, Physician Assistants and
        ...
        <h2>Couples report that the FC System benefits the relationship</h2>
        <p>Couples report an increase in communication and a growth in the</p>
        <p><b style={{"font-size": "22px"}}>S</b>piritual</p>
        <p><b style={{"font-size": "22px"}}>P</b>hysical</p>
        <p><b style={{"font-size": "22px"}}>I</b>ntellectual</p>
        <p><b style={{"font-size": "22px"}}>C</b>ommunicative/Creative</p>
        <p><b style={{"font-size": "22px"}}>E</b>motional dimensions their sexuality and relationship.</p>

        <div className="center">
            <h3>For more information on the</h3>
            <h3>CREIGHTON MODEL</h3>
            <h3>{FC}{TM} System go to:</h3>
            <h3><a href="http://www.FC.org" target="__blank">www.FC.org</a></h3>
